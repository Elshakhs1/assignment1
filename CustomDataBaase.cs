...
namespace DataStructureAlgorithms
{
    internal class CustomDataBaase
    {
        ...
        public void PopulateWithSampleStudent()
        {
            ...
            Student student1 = new Student("ISLAM", "ELSHAKHS", "6564", score1);
            float[] score2 = { 10, 20, 30, 40 };
            Student student2 = new Student("HOSSAM", "GHALY", "652", score2);
            float[] score3 = { 70, 80, 90, 100 };
            Student student3 = new Student("JOERG", "TAMER"; "6541", score3);
            float[] score4 = { 24, 67, 32, 44 };
            Student student4 = new Student("JHONY", "DEEB", "26524", score4);
